...
CREATE TABLE IF NOT EXISTS lassu.user_detail1(
...
CREATE TABLE IF NOT EXISTS lassu.user_detail1_audit1(
	audit_id BIGINT PRIMARY KEY,
	user_id BIGINT NOT NULL,
	reporting_site VARCHAR(255) NOT NULL,
	crtn_ts timestamp without time zone NOT NULL,
	CONSTRAINT user_detail1_audit_fk_ FOREIGN KEY (user_id) REFERENCES lassu.user_detail1 (user_id)
);
