...
import com.lassu.security.service.AuthAuditConsumer;
...
public class BootLoader implements CommandLineRunner {
	...
	@Autowired
	private AuthAuditConsumer authAuditConsumer;
	...
	public void run(String... args) throws Exception {
		eventBus.on($(CommonConstant.COMPONENT_AUTHAUDIT_PROCESSOR), authAuditConsumer);
	}
