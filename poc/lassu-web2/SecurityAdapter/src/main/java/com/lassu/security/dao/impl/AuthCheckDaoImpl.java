...
@Repository
@EnableRetry
public class AuthCheckDaoImpl implements AuthCheckDao {
	...
	private static final String RETRIEVE_SQL_BY_USERNAME = "SELECT * FROM lassu.user_detail2 where username =:username";
	private static final String INSERT_SQL = "INSERT INTO lassu.user_detail1_audit2 ("
			+ " audit_id, user_id, reporting_site, crtn_ts" + ") VALUES ("
			+ " :audit_id, :user_id, :reporting_site, now()" + ")";
	private static final String UPDATE_SQL = "SELECT * FROM lassu.user_detail2 where user_id = ? for update";

	/* (non-Javadoc)
	 * @see com.lassu.security.dao.AuthCheckDao#getUserUsername(java.lang.String)
	 */
	@Override
